...
contract LimitedOCPointsMerkleClaimMock is LimitedOCPointsMerkleClaim {
    constructor(address pointsContractAddress, uint256 poolSize, bytes32 pointsDepositReasonCode, IForwarderRegistry forwarderRegistry) LimitedOCPointsMerkleClaim(pointsContractAddress, poolSize, pointsDepositReasonCode, forwarderRegistry) {}
