...
describe('GenesisTokenEscrow', function () {
  ...
  context('Deploy Contract', function () {
    ...
    it('Deploy with invalid ERC1155 contract', async function () {
      await expect(deployContract('GenesisTokenEscrow', ethers.ZeroAddress, this.forwarderRegistryAddress))
        .to.be.revertedWithCustomError(this.escrow1155, 'InvalidInventory');
    });
  });

  context('Deposit via safeTransferFrom', async function () {
  ...
  context('Deposit via safeBatchTransferFrom', function () {
    it('Deposit 2 Golden and 1 Silver for pNFT #0', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [0], [2n], [1n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 1n], data))
        .to.emit(this.escrow1155, 'Deposited')
    ...
    it('Deposit 1 Golden and 1 Silver for pNFT #1, 1 Golden for pNFT #2', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address, this.erc721Address], [1n, 2n], [1n, 1n], [1n, 0n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 1n], data))
        .to.emit(this.escrow1155, 'Deposited')
        .withArgs(deployer.address, [this.erc721Address, this.erc721Address], [1n, 2n], [[1n, 1n], [1n, 0n]]);
    ...
    it('Deposit 1 Golden and 1 Silver for pNFT #0, 1 Golden for an alternative pNFT #1', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address, this.erc721AddressAlt], [0, 1n], [1n, 1n], [1n, 0n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 1n], data))
        .to.emit(this.escrow1155, 'Deposited')
        .withArgs(deployer.address, [this.erc721Address, this.erc721AddressAlt], [0, 1n], [[1n, 1n], [1n, 0n]]);
    ...
    it('Deposit 2 Golden for pNFT #0, then deposit 1 Golden and 4 Silver for pNFT #0', async function () {
      const data1 = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [0], [2n], [0]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 0], data1))
        .to.emit(this.escrow1155, 'Deposited')
      ...
      const data2 = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [0], [1n], [4n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [1n, 4n], data2))
        .to.emit(this.escrow1155, 'Deposited')
    ...
    it('Deposit 2 Golden and 4 Silver for pNFT #0 separately, then withdraw everything from pNFT #0, after that deposit 2 Golden and 3 Silver for pNFT #0', async function () {
      const data1 = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [0], [1n], [0]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [1n, 0], data1))
        .to.emit(this.escrow1155, 'Deposited')
      ...
      .to.emit(this.escrow1155, 'Withdrawn').withArgs(deployer.address, [this.erc721Address], [0]);

      const data3 = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [0], [2n], [3n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 3n], data3))
        .to.emit(this.escrow1155, 'Deposited')
    ...
    it('Deposit unknown Genesis token id 3', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [0], [0]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [3n], [1n], data))
      .to.be.revertedWithCustomError(this.escrow1155, 'InvalidInputParams');
    });

    it('Deposit 1 Golden and 1 Silver for pNFT #1, but the data claims it has 2 Golden and 1 Silver', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [2n], [1n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [1n, 1n], data))
      .to.be.revertedWithCustomError(this.escrow1155, 'InvalidInputParams');
    });

    it('Deposit 1 Golden and 1 Silver for pNFT #1, but the data claims it has 1 Golden and 2 Silver', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [1n], [2n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [1n, 1n], data))
      .to.be.revertedWithCustomError(this.escrow1155, 'InvalidInputParams');
    });
    ...
    it('Deposit some Genesis tokens, but the data contains inconsistent array lengths for pNFT address and pNFT tokenId', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n, 2n], [2n], [1n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 1n], data))
    ...
    it('Deposit some Genesis tokens, but the data contains inconsistent array lengths for Golden tokenIds and pNFT addresses', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [1n, 2n], [1n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 1n], data))
      .to.be.revertedWithCustomError(this.escrow1155, 'InconsistentArrayLengths');
    });
    ...
    it('Deposit some Genesis tokens, but the data contains inconsistent array lengths for Silver tokenIds and pNFT addresses', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [2n], [1n, 2n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 0], data))
      .to.be.revertedWithCustomError(this.escrow1155, 'InconsistentArrayLengths');
    });
    ...
    it('Deposit some Genesis tokens, but the actual transfer amount of Golden(3) is more than what described in data(2)', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [2n], [2n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [3n, 2n], data))
      .to.be.revertedWithCustomError(this.escrow1155, 'InvalidInputParams');
    });
    ...
    it('Deposit some Genesis tokens, but the actual transfer amount of Silver(3) is more than what described in data(2)', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [2n], [2n]]);
      await expect(this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 3n], data))
      .to.be.revertedWithCustomError(this.escrow1155, 'InvalidInputParams');
    });
  ...
  context('Withdraw', function () {
    it('Withdraw Genesis tokens from pNFT #1, which it had 0 Golden and 1 Silver being staked', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [0], [1n]]);
      await this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [0, 1n], data);
      await expect(this.escrow1155.withdraw([this.erc721Address], [1n]))
      .to.emit(this.escrow1155, 'Withdrawn').withArgs(deployer.address, [this.erc721Address], [1n]);
    });

    it('Withdraw Genesis tokens from pNFT #1, which it had 1 Golden and 0 Silver being staked', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [1n], [0]]);
      await this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [1n, 0], data);
      await expect(this.escrow1155.withdraw([this.erc721Address], [1n]))
      .to.emit(this.escrow1155, 'Withdrawn').withArgs(deployer.address, [this.erc721Address], [1n]);
    });

    it('Withdraw Genesis tokens from pNFT #1, which it had 1 Golden and 1 Silver being staked', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [1n], [1n]]);
      await this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [1n, 1n], data);
      await expect(this.escrow1155.withdraw([this.erc721Address], [1n]))
      .to.emit(this.escrow1155, 'Withdrawn').withArgs(deployer.address, [this.erc721Address], [1n]);
    });

    it('Withdraw Genesis tokens from pNFT #1 and #2', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address, this.erc721Address], [1n, 2n], [1n, 1n], [1n, 1n]]);
      this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [2n, 2n], data);
      await expect(this.escrow1155.withdraw([this.erc721Address, this.erc721Address], [1n, 2n]))
      .to.emit(this.escrow1155, 'Withdrawn').withArgs(deployer.address, [this.erc721Address, this.erc721Address], [1n, 2n]);
    });
    ...
    it('Withdraw Genesis tokens from pNFT #1 and #2, but nothing is escrowed for pNFT #2', async function () {
      const data = ethers.AbiCoder.defaultAbiCoder().encode(['address[]', 'uint256[]', 'uint256[]', 'uint256[]'], [[this.erc721Address], [1n], [1n], [1n]]);
      this.erc1155['safeBatchTransferFrom(address,address,uint256[],uint256[],bytes)'](deployer.address, this.erc1155EscrowAddress, [1n, 2n], [1n, 1n], data);
    ...
    it('Withdraw some Genesis tokens, but pNFT addresses length and pNFT tokenId length are mismatched', async function () {
      await expect(this.escrow1155.withdraw([this.erc721Address], [2n, 3n]))
      .to.be.revertedWithCustomError(this.escrow1155, 'InconsistentArrayLengths');
    });
  });
